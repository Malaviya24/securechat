...
```bash
git remote add encore encore://secure-chat-app-rami
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/secure-chat-app-rami/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/secure-chat-app-rami/settings/integrations/github)
